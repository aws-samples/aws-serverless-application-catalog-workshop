...
```bash
my-application$ sam local invoke putItemFunction --event event-post-item.json
my-application$ sam local invoke getAllItemsFunction --event event-get-all-items.json
```
